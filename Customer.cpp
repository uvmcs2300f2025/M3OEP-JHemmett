...
Customer::Customer(string firstName, string lastName, string phoneNumber, int customerId): firstName(firstName), lastName(lastName), phoneNumber(phoneNumber), customerId(customerId){}
